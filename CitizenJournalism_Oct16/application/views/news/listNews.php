...
<?php foreach ($news as $news_item): ?>
    ...
    <div>
	    <a href="<?php echo base_url().'index.php/news/approve/'.$news_item['n_id'] ?>"><input class="button small gradient blue rnd8" type="button" value="Approve"></a>
		<a href="<?php echo base_url().'index.php/news/delete/'.$news_item['n_id'] ?>"><input class="button small gradient red rnd8" type="button" value="Delete"></a>
	</div>
	<br>
<?php endforeach ?>
</div>
